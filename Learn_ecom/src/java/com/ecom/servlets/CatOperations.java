 ...
 * @author pc
 */
public class CatOperations extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet CatOperations</title>");
            out.println("</head>");
            out.println("<body>");

            String operation = request.getParameter("operation");

            if (operation.equals("add_cat")) {
                //add category..
                try {
                    ...
                    String query = "insert into category(cName,cDesc) values (?,?)";

                    PreparedStatement pstmt = c.prepareStatement(query);

                    pstmt.setString(1, cat_name);
                    pstmt.setString(2, cat_desc);

                    pstmt.executeUpdate();

                    //msg
                    Message msg = new Message("Category Added", "success");
